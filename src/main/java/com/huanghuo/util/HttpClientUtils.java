...
public class HttpClientUtils {
    ...
    public static HttpResult post(String url, Map<String, String> headers, Map<String, Object> params, Charset charset, RequestConfig requestConfig, HttpContext context) {
    ...
    public static HttpResult postUsingJson(String url, Map<String, String> headers, Map<String, Object> params, RequestConfig requestConfig, HttpContext context) {
        HttpPost request = new HttpPost(url);
        if (MapUtils.isNotEmpty(headers)) {
            for (Map.Entry<String, String> entry : headers.entrySet()) {
                request.addHeader(entry.getKey(), entry.getValue());
    ...
    public static HttpResult post(String url, Map<String, Object> params, int timeout) {
        RequestConfig requestConfig = RequestConfig.custom()
            .setSocketTimeout(timeout)
            .setConnectTimeout(timeout)
            .setConnectionRequestTimeout(timeout).build();
        return post(url, null, params,  Charset.forName("utf-8"), requestConfig, HttpClientContext.create());
    }

    public static HttpResult post(String url, Map<String, Object> params, Charset charset) {
        return post(url, null, params, charset, defaultRequestConfig, HttpClientContext.create());
    }

    public static HttpResult post(String url, Map<String, String> headers, Map<String, Object> params, Charset charset) {
        return post(url, headers, params, charset, defaultRequestConfig, HttpClientContext.create());
    }
    ...
    public static HttpResult postUsingJson(String url, Map<String, Object> params) {
        return postUsingJson(url, null, params, defaultRequestConfig, HttpClientContext.create());
    }

    public static HttpResult postUsingJson(String url, Map<String, String> headers, Map<String, Object> params) {
        return postUsingJson(url, headers, params, defaultRequestConfig, HttpClientContext.create());
    }
    ...
    public static HttpResult execute(String url, RequestMethod method, Map<String, Object> params, Charset charset, RequestConfig requestConfig, HttpContext context) {
        switch (method) {
            ...
            case POST:
                return post(url, null, params, charset, requestConfig, context);
            case PUT:
    ...
    private static HttpEntity createJsonEntity(Map<String, Object> params) {
        ...
        String json = JsonUtil.getJsonString(params);
    ...
    public static class HttpResult {
        ...
        public Map<String, Object> getJsonContent() {
            ...
            return JsonUtil.getMapFromJson(getContentAsString());
        }
    }
